window.addEventListener("load", function () {
  ...
  class InputHandler {
    constructor(game) {
      ...
      window.addEventListener("keyup", (e) => {
        const indexOfKey = this.game.keys.indexOf(e.key);
        if (indexOfKey > -1) {
  ...
  class Particle {
    ...
    update() {
      ...
      if (
        this.y > this.game.height - this.size - this.bottomBounceBoundary &&
        !this.bounced
      ) {
        this.bounced = true;
        this.speedY *= -0.5;
  ...
  class Layer {
    ...
    draw(context) {
      // adiciona duas imagens iguais pra fazer o efeito de loop
    ...
    draw(context) {
      ...
      if (this.game.gameOver) {
        ...
        if (this.game.score >= this.game.winningScore) {
          message1 = "Você ganhou!";
          message2 = "Bom trabalho!";
        } else {
          message1 = "Você perdeu!";
          message2 = "Mais sorte da próxima vez!";
        }
  ...
  class Game {
    ...
    update(deltaTime) {
      ...
      this.background.layer4.update(); //aqui para ficar na frente de tudo
    ...
    draw(context) {
      ...
      this.background.layer4.draw(context); //aqui para ficar na frente de tudo
    }

    addEnemy() {
      const randomize = Math.random();
      if (randomize < 0.1) this.enemies.push(new Angler1(this));
      if (randomize < 0.3) this.enemies.push(new Stalker(this));
      if (randomize < 0.5) this.enemies.push(new Razorfin(this));
